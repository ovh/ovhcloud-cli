...
func (ms *MockSuite) TestCloudFloatingIPListCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "ip", "ls", "--type", "floating", "--cloud-project", "fakeProjectID", "-o", "json")
...
func (ms *MockSuite) TestCloudFloatingIPListWithRegionFilterCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "ip", "ls", "--type", "floating", "--cloud-project", "fakeProjectID", "--region", "GRA11", "-o", "json")
	require.CmpNoError(err)
	assert.Cmp(json.RawMessage(out), td.JSON(`[
		{
			"id": "fip-gra-001",
...
func (ms *MockSuite) TestCloudFloatingIPGetCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "ip", "get", "fip-gra-001", "--type", "floating", "--cloud-project", "fakeProjectID", "--region", "GRA11", "-o", "json")
	require.CmpNoError(err)
	assert.Cmp(json.RawMessage(out), td.JSON(`{
		"id": "fip-gra-001",
		"ip": "1.2.3.4",
...
func (ms *MockSuite) TestCloudFloatingIPDeleteCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "ip", "delete", "fip-gra-001", "--type", "floating", "--cloud-project", "fakeProjectID", "--region", "GRA11", "-o", "json")
	require.CmpNoError(err)
	assert.Cmp(json.RawMessage(out), td.JSON(`{
...
func (ms *MockSuite) TestCloudFailoverIPListCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "ip", "ls", "--type", "failover", "--cloud-project", "fakeProjectID", "-o", "json")
	require.CmpNoError(err)
	assert.Cmp(json.RawMessage(out), td.JSON(`[
		{
			"id": "failover-001",
...
func (ms *MockSuite) TestCloudFailoverIPGetCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "ip", "get", "failover-001", "--type", "failover", "--cloud-project", "fakeProjectID", "-o", "json")
	require.CmpNoError(err)
	assert.Cmp(json.RawMessage(out), td.JSON(`{
		"id": "failover-001",
		"ip": "9.8.7.6",
...
func (ms *MockSuite) TestCloudFailoverIPAttachCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "ip", "attach", "failover-001", "instance-123", "--type", "failover", "--cloud-project", "fakeProjectID", "-o", "json")
	require.CmpNoError(err)
	assert.Cmp(json.RawMessage(out), td.JSON(`{
