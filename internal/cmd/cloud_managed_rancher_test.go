...
func (ms *MockSuite) TestCloudRancherCreateCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "managed-rancher", "create", "--cloud-project", "fakeProjectID", "--name", "test-rancher", "--plan", "OVHCLOUD_EDITION", "--version", "2.11.3")
...
func (ms *MockSuite) TestCloudRancherCreateCmdJSONFormat(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "managed-rancher", "create", "--cloud-project", "fakeProjectID", "--name", "test-rancher", "--plan", "OVHCLOUD_EDITION", "--version", "2.11.3", "-o", "json")
	require.CmpNoError(err)
...
func (ms *MockSuite) TestCloudRancherCreateCmdYAMLFormat(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "managed-rancher", "create", "--cloud-project", "fakeProjectID", "--name", "test-rancher", "--plan", "OVHCLOUD_EDITION", "--version", "2.11.3", "-o", "yaml")
	require.CmpNoError(err)
...
func (ms *MockSuite) TestCloudRancherCreateCmdCustomFormat(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "managed-rancher", "create", "--cloud-project", "fakeProjectID", "--name", "test-rancher", "--plan", "OVHCLOUD_EDITION", "--version", "2.11.3", "-o", "[details.id]")
	require.CmpNoError(err)
...
func (ms *MockSuite) TestCloudRancherResetAdminCredentialsCmd(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "managed-rancher", "reset-admin-credentials", "--cloud-project", "fakeProjectID", "fakeRancherID")
	require.CmpNoError(err)
...
func (ms *MockSuite) TestCloudRancherCreateCmdWithIamAuthEnabledTrue(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "managed-rancher", "create", "--cloud-project", "fakeProjectID", "--name", "test-rancher", "--plan", "OVHCLOUD_EDITION", "--version", "2.11.3", "--iam-auth-enabled=true")
	require.CmpNoError(err)
	assert.String(out, `✅ Rancher test-rancher created successfully (id: rancher-12345)`)
}
...
func (ms *MockSuite) TestCloudRancherCreateCmdWithIamAuthEnabledFalse(assert, require *td.T) {
	...
	out, err := cmd.Execute("cloud", "managed-rancher", "create", "--cloud-project", "fakeProjectID", "--name", "test-rancher", "--plan", "OVHCLOUD_EDITION", "--version", "2.11.3", "--iam-auth-enabled=false")
	require.CmpNoError(err)
	assert.String(out, `✅ Rancher test-rancher created successfully (id: rancher-12345)`)
}
