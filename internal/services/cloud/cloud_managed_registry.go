...
var (
	...
	//go:embed templates/cloud_managed_registry.tmpl
	cloudContainerRegistryTemplate string

	//go:embed templates/cloud_managed_registry_user.tmpl
	cloudContainerRegistryUserTemplate string

	//go:embed parameter-samples/managed-registry-create.json
	CloudContainerRegistryCreateSample string

	//go:embed parameter-samples/managed-registry-user-create.json
	CloudContainerRegistryUserCreateSample string

	//go:embed parameter-samples/managed-registry-iam-enable.json
	CloudContainerRegistryIamEnableSample string

	//go:embed parameter-samples/managed-registry-oidc-create.json
