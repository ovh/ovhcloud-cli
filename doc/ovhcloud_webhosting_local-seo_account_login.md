## ovhcloud webhosting local-seo account login

Generate an SSO link for a Local SEO account

```
ovhcloud webhosting local-seo account login <service_name> <id> [flags]
```
