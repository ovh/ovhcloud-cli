## ovhcloud cloud managed-analytics certificate get

Get certificates in the given managed analytics service

```
ovhcloud cloud managed-analytics certificate get <service_id> [flags]
```
