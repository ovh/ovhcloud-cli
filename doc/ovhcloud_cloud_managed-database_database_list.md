## ovhcloud cloud managed-database database list

List all databases in the given managed database service

```
ovhcloud cloud managed-database database list <service_id> [flags]
```
