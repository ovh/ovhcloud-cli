## ovhcloud baremetal backup ftp create

Create the Backup FTP space included with this server

```
ovhcloud baremetal backup ftp create <service_name> [flags]
```
...
```
  ...
  -h, --help      help for create
      --wait      Wait until the space actually exists before exiting
