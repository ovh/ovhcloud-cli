## ovhcloud cloud managed-database user get

Get a specific user in the given managed database service

```
ovhcloud cloud managed-database user get <service_id> <user_id> [flags]
```
