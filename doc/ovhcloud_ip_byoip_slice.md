## ovhcloud ip byoip slice

Split this block into smaller ones

```
ovhcloud ip byoip slice <ip_block> [flags]
```
...
```
  ...
  -h, --help                help for slice
      --size byoip slices   Prefix length of the smaller blocks, as listed by byoip slices (required)
