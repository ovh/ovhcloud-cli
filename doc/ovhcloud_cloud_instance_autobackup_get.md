## ovhcloud cloud instance autobackup get

Get details of an automatic backup workflow

```
ovhcloud cloud instance autobackup get <instance_id> <backup_workflow_id> [flags]
```
