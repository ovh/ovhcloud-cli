## ovhcloud baremetal backup cloud password

Reset the four cloud backup passwords

```
ovhcloud baremetal backup cloud password <service_name> [flags]
```
...
```
  ...
  -h, --help      help for password
      --reveal    Print the new passwords instead of their fingerprints
