## ovhcloud cloud managed-analytics topic delete

Delete a specific topic in the given managed analytics service

```
ovhcloud cloud managed-analytics topic delete <service_id> <topic_id> [flags]
```
