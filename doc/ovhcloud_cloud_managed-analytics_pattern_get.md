## ovhcloud cloud managed-analytics pattern get

Get a specific pattern in the given managed analytics service

```
ovhcloud cloud managed-analytics pattern get <service_id> <pattern_id> [flags]
```
