## ovhcloud cloud managed-analytics database create

Create a new database in the given managed analytics service
...
```
ovhcloud cloud managed-analytics database create <service_id> [flags]
```
