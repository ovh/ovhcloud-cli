## ovhcloud cloud managed-database database get

Get a specific database in the given managed database service

```
ovhcloud cloud managed-database database get <service_id> <database_id> [flags]
```
