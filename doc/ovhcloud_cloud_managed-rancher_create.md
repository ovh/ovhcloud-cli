...
```
ovhcloud cloud managed-rancher create [flags]
```
...
```
  ...
  -h, --help               help for create
      ...
      --plan string        Plan of the managed Rancher service (available plans can be listed using 'cloud reference managed-rancher list-plans' command)
      --replace            Replace parameters file if it already exists
      --version string     Version of the managed Rancher service (available versions can be listed using 'cloud reference managed-rancher list-versions' command)
```
