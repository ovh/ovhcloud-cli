## ovhcloud cloud managed-analytics database get

Get a specific database in the given managed analytics service

```
ovhcloud cloud managed-analytics database get <service_id> <database_id> [flags]
```
