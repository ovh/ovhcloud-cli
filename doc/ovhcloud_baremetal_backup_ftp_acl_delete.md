## ovhcloud baremetal backup ftp acl delete

Stop an IP block reaching the Backup FTP space

```
ovhcloud baremetal backup ftp acl delete <service_name> <ip_block> [flags]
```
