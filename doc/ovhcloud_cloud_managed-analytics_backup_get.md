## ovhcloud cloud managed-analytics backup get

Get a specific backup in the given managed analytics service

```
ovhcloud cloud managed-analytics backup get <service_id> <backup_id> [flags]
```
