## ovhcloud baremetal backup ftp delete

Terminate the Backup FTP space — all data is permanently deleted

```
ovhcloud baremetal backup ftp delete <service_name> [flags]
```
...
```
  ...
  -h, --help      help for delete
      --wait      Wait until the space is actually gone before exiting
