## ovhcloud cloud container-registry oidc create

Create a new OIDC configuration for a container registry

```
ovhcloud cloud container-registry oidc create <registry_id> [flags]
```
...
```
      ...
      --delete-users           Delete existing local users when enabling OIDC
