## ovhcloud cloud managed-analytics backup list

List all backups in the given managed analytics service

```
ovhcloud cloud managed-analytics backup list <service_id> [flags]
```
