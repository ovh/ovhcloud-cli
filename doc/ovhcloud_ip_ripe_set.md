## ovhcloud ip ripe set

Change the RIPE record of this block

```
ovhcloud ip ripe set <ip_block> [flags]
```

### Options

```
      --description string   Description published in the registry
      --dry-run              Print the call that would be made without making it
  -h, --help                 help for set
      --netname string       Netname published in the registry
