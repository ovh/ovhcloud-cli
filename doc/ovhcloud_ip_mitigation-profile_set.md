## ovhcloud ip mitigation-profile set

Set the auto-mitigation delay of an address, creating its profile if needed

```
ovhcloud ip mitigation-profile set <ip_block> <ip> [flags]
```
...
```
  ...
  -h, --help          help for set
      --timeout int   Minutes auto-mitigation stays on after an attack: 0, 15, 60, 360 or 1560
