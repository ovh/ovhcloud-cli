## ovhcloud ip byoip aggregate

Merge this block with its neighbours

```
ovhcloud ip byoip aggregate <ip_block> [flags]
```
...
```
  ...
  -h, --help                      help for aggregate
      --into byoip aggregations   Parent block to merge into, as listed by byoip aggregations (required)
