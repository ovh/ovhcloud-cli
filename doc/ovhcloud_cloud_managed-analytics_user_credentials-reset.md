## ovhcloud cloud managed-analytics user credentials-reset

Reset the credentials of a specific user in the given managed analytics service

```
ovhcloud cloud managed-analytics user credentials-reset <service_id> <user_id> [flags]
```
