## ovhcloud cloud container-registry ip-restrictions management delete

Delete a management IP restriction from a container registry

```
ovhcloud cloud container-registry ip-restrictions management delete <registry_id> [flags]
```
