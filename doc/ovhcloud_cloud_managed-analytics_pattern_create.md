## ovhcloud cloud managed-analytics pattern create

Create a new pattern in the given managed analytics service

```
ovhcloud cloud managed-analytics pattern create <service_id> [flags]
```
...
```
  ...
  -h, --help                  help for create
      --max-index-count int   Maximum number of index for this pattern (clickhouse only)
