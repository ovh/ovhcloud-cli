## ovhcloud ip service change-contact

Start a contact change procedure on an IP service

```
ovhcloud ip service change-contact <service_name> [flags]
```

### Options

```
      --admin string     New administrative contact
      --billing string   New billing contact
      --dry-run          Print the call that would be made without making it
  -h, --help             help for change-contact
      --tech string      New technical contact
