## ovhcloud cloud managed-database backup restore

Restore a specific backup in the given managed database service

```
ovhcloud cloud managed-database backup restore <service_id> <backup_id> [flags]
```
