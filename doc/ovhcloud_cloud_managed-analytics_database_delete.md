## ovhcloud cloud managed-analytics database delete

Delete a specific database in the given managed analytics service

```
ovhcloud cloud managed-analytics database delete <service_id> <database_id> [flags]
```
