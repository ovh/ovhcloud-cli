## ovhcloud baremetal logs unsubscribe

Stop sending the logs of this server to a stream

```
ovhcloud baremetal logs unsubscribe <service_name> <subscription_id> [flags]
```
...
```
  ...
  -h, --help      help for unsubscribe
      --wait      Wait until the subscription is actually gone before exiting
