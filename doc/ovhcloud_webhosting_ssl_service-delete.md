## ovhcloud webhosting ssl service-delete

Delete the service-level SSL certificate

```
ovhcloud webhosting ssl service-delete <service_name> [flags]
```

### Options

```
  -h, --help   help for service-delete
```
