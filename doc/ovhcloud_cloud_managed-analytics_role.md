## ovhcloud cloud managed-analytics role

Manage roles in a specific managed analytics service
...
* [ovhcloud cloud managed-analytics role list](ovhcloud_cloud_managed-analytics_role_list.md)	 - List roles in the given managed analytics service
