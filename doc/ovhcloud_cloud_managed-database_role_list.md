## ovhcloud cloud managed-database role list

List roles in the given managed database service

```
ovhcloud cloud managed-database role list <service_id> [flags]
```

### Options

```
      --advanced             Adds the advanced roles to the list of the roles (mongodb only)
