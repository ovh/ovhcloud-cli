...
* [ovhcloud cloud storage block volume create-from-backup](ovhcloud_cloud_storage_block_volume_create-from-backup.md)	 - Create a volume from the given backup
